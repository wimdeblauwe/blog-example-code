...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        HxRefreshHeaderAuthenticationEntryPoint entryPoint = new HxRefreshHeaderAuthenticationEntryPoint();
        RequestHeaderRequestMatcher requestMatcher = new RequestHeaderRequestMatcher("HX-Request");
